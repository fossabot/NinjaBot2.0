...
client.on("ready",  async () => {
  ...
  client.user.setActivity(`Ninja Bot Beta`);
});
...
if (message.content.toLowerCase().startsWith(config.prefix + `add`)) {
 ...
 if(command === "help") {
   ...
   .setColor("0xff80ff")
   .addField("Kick", "Kicks the mentioned user **phkick @user**")
   .addField("Ban", "Bans mentioned user **phban @user <reason>**")
   .addField("Serverlist", "Shows a list of guilds the bots in")
   .addField("About", "Shows info about the bot")
   .addField("Report", "Reports mentioned user for supplied reason **phreport @user <reason>**")
   .addField("Sendembed", "Send an embeded message **phsendembed test**")
   .addField("suggest", "Sends your suggestion to the placeholder support server **phsuggest <suggestion>**")
   .addField("Removerole", "Removes the mentioned role from the mentioned user **phremoverole @user @rolename**")
   .addField("Say", "Sends your provided message **phsay <message>**")
   .addField("Purge", "Deletes the provided number of messages **phpurge <number of messages>**")
   .addField("new", "Opens a new support ticket **phnew <reason>**")
   .addField("close", "Closes a support ticket **phclose <#ticketchannel>**  note you have to send this command inside of the ticket channel")
