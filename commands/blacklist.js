...
exports.run = async (client, message, args) => {
    //message.delete();
    let blacklist = JSON.parse(fs.readFileSync("../data/blacklist.json", "utf8"));
    let user = args[0];
    ...
    if (!message.author.id === '444609097233465347') return message.reply("You don't have the permission to use this command...:facepalm:");
    ...
    if (args[0] === '444609097233465347') return message.reply("You can't blacklist yourself, Dev:joy: That would be horrible.");
